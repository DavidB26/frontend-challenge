...
const Header = () => {
  return (
    <header className="w-full bg-transparent flex items-center justify-between px-8 py-4 md:px-16 md:py-6 ">
      {/* Logo */}
      ...
      {/* Contact info */}
      <div className="flex flex-col md:flex-row items-center text-sm md:text-base font-medium" style={{ color: "rgba(3, 5, 15, 1)" }}>
